...
module.exports = class AprovadorController {
    ...
    static async criarRelatorioAprovacao(req, res) {
        ...
        if (data.checkboxDocumentacaoProdutoAprovado && data.checkboxDocumentacaoProdutoRecusado) {
        ...
        } else if (!data.checkboxDocumentacaoProdutoAprovado && !data.checkboxDocumentacaoProdutoRecusado){
        ...
        if (data.checkboxInfoRecebedorAprovado && data.checkboxInfoRecebedorRecusado) {
        ...
        } else if (!data.checkboxInfoRecebedorAprovado && !data.checkboxInfoRecebedorRecusado){
        ...
        if (data.checkboxInfoAnalistaAprovado && data.checkboxInfoAnalistaRecusado) {
        ...
        } else if (!data.checkboxInfoAnalistaAprovado && !data.checkboxInfoAnalistaRecusado){
        ...
        try {
            ...
            const atualizacaoStatusAnalista = await RelatorioAnalista.update(
                { status_aprovacao: 'Concluído' },
                { where: { id_pedido: data.idPedido}, returning: true }
            );
