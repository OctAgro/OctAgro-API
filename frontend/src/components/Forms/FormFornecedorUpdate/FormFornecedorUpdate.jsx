...
// IMPORTANDO HOOK
import { atualizarFornecedor } from "../../../hooks/atualizarFornecedor"
import { procurarFornecedor } from "../../../hooks/procurarFornecedor"

export const FormFornecedorUpdate = () => {
  ...
  useEffect(() => {
    async function fetchProdutos() {
      const dadosProdutos = await procurarFornecedor(fornecedorId)
      setFornecedor(dadosProdutos)
      /*       console.log('Informações do Produto que chegam do BackEnd ' + JSON.stringify(dadosProdutos.data.message)) */
      setCNPJ(dadosProdutos.CNPJ)
      setIE(dadosProdutos.IE)
      setRazaoSocial(dadosProdutos.razao_social)
      setResponsavel(dadosProdutos.responsavel)
      setTelefone(dadosProdutos.telefone)
      setTelCelular(dadosProdutos.tel_celular)
      setEmail1(dadosProdutos.e_mail1)
      setEmail2(dadosProdutos.e_mail2)
      setCep(dadosProdutos.cep)
      setEstado(dadosProdutos.estado)
      setCidade(dadosProdutos.cidade)
      setBairro(dadosProdutos.bairro)
      setEndereco(dadosProdutos.endereco)
      setNumero(dadosProdutos.numero)
      setComplemento(dadosProdutos.complemento)
      setComentario(dadosProdutos.comentario)
      setNomeFornecedor(dadosProdutos.nome_fornecedor)
    }
    fetchProdutos()
  }, [])

  console.log("fornecedores aqui: ", fornecedor)
