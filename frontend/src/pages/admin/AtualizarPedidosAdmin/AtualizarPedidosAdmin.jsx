...
import { FormAtualizarPedidos } from "../../../components/Forms/FormAtualizarPedidos/FormAtualizarPedidos"
...
// Importando CSS
import styles from "./AtualizarPedidosAdmin.module.css"

export const AtualizarPedidosAdmin = () => {
    ...
    <PedidosProvider>
      <div id={styles["main"]}>
        ...
        <div id={styles["body"]}>
          ...
          <FormAtualizarPedidos onClick={handleOpenModalPedidosCadastrado} />
